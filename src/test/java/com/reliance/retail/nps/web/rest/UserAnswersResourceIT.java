...
class UserAnswersResourceIT {
    ...
    public static UserAnswers createEntity(EntityManager em) {
        UserAnswers userAnswers = new UserAnswers().answers(DEFAULT_ANSWERS).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
        return userAnswers;
    }
    ...
    public static UserAnswers createUpdatedEntity(EntityManager em) {
        UserAnswers userAnswers = new UserAnswers().answers(UPDATED_ANSWERS).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
        return userAnswers;
    }
    ...
    void putNewUserAnswers() throws Exception {
        ...
        updatedUserAnswers.answers(UPDATED_ANSWERS).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateUserAnswersWithPatch() throws Exception {
        ...
        partialUpdatedUserAnswers.answers(UPDATED_ANSWERS);
    ...
    void fullUpdateUserAnswersWithPatch() throws Exception {
        ...
        partialUpdatedUserAnswers.answers(UPDATED_ANSWERS).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
