...
import com.reliance.retail.nps.repository.ReviewRepository;
import com.reliance.retail.nps.service.dto.ReviewDTO;
import com.reliance.retail.nps.service.mapper.ReviewMapper;
...
class ReviewResourceIT {
    ...
    public static Review createEntity(EntityManager em) {
        Review review = new Review().rating(DEFAULT_RATING);
        return review;
    }
    ...
    public static Review createUpdatedEntity(EntityManager em) {
        Review review = new Review().rating(UPDATED_RATING);
        return review;
    }
    ...
    void putNewReview() throws Exception {
        ...
        updatedReview.rating(UPDATED_RATING);
