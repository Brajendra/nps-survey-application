...
import com.reliance.retail.nps.repository.CustomerRepository;
import com.reliance.retail.nps.service.dto.CustomerDTO;
import com.reliance.retail.nps.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().firstName(DEFAULT_FIRST_NAME);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().firstName(UPDATED_FIRST_NAME);
        return customer;
    }
