...
class CampaignLinkResourceIT {
    ...
    void putNewCampaignLink() throws Exception {
        ...
        updatedCampaignLink.code(UPDATED_CODE).userInfo(UPDATED_USER_INFO).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateCampaignLinkWithPatch() throws Exception {
        ...
        partialUpdatedCampaignLink.userInfo(UPDATED_USER_INFO).createdAt(UPDATED_CREATED_AT);
