...
import { getEntities as getUserAnswers } from 'app/entities/user-answers/user-answers.reducer';
...
export const QuestionUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const userAnswers = useAppSelector(state => state.userAnswers.entities);
