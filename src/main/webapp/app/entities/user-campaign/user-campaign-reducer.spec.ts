...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCAMPAIGN_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCAMPAIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCAMPAIGN actions', async () => {
      const expectedActions = [
        {
