...
public class QuestionServiceImpl implements QuestionService {
    ...
    /**
     *  Get all the questions where UserAnswer is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<QuestionDTO> findAllWhereUserAnswerIsNull() {
        log.debug("Request to get all questions where UserAnswer is null");
