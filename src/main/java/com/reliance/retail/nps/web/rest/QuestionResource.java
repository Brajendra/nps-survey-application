...
public class QuestionResource {
    ...
    public ResponseEntity<List<QuestionDTO>> getAllQuestions(
        ...
        if ("useranswer-is-null".equals(filter)) {
            log.debug("REST request to get all Questions where userAnswer is null");
            return new ResponseEntity<>(questionService.findAllWhereUserAnswerIsNull(), HttpStatus.OK);
        }
